<%-- 
    Document   : index
    Created on : 5/10/2022, 21:21:29
    Author     : Jorge
--%>


<%@page import="modelo.estudiante" %>
<%@page import="modelo.tiposSangre" %>
...
<html>
    ...
    <body>
        ...
        <button type="button" name="btn_nuevo" id="btn_nuevo" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_estudiante" 
                onclick="limpiar()">Nuevo</button>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="sr_estudiante" method="post" class="form-group">
                                ...
                                <label for="lbl_correoElectronico" ><b>Correo Electronico</b></label>
                                <input type="text" name="txt_correoElectronico" id="txt_correoElectronico" class="form-control" placeholder="Ejemplo: jorge@miempresa.com" required>
                                <label for="lbl_sangre" ><b>Sangre</b></label>
                                <select name="drop_sangre" id="drop_sangre" class="form-control">
                                    <% 
                                        tiposSangre tiposSangre = new tiposSangre();
                                        HashMap<String,String> drop = tiposSangre.drop_sangre();
                                ...
                                <button name="btn_eliminar" id="btn_modificar"  value="eliminar" class="btn btn-danger btn-lg" onclick="javascript:if (!confirm('¿Desea Eliminar?'))
            ...
            <table class="table table-striped" >
                ...
                <script type="text/javascript">
                                                    ...
                                                    $('#tbl_estudiantes').on('click', 'tr td', function (evt) {
                                                        var target, id, id_p, carne, nombres, apellidos, direccion, telefono, nacimiento;
                                                        target = $(event.target);
